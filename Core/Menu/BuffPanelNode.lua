...
--   self:SetBackColor(Turbine.UI.Color(0.93,0.66,1,0.63));
...
--   self.panel:SetBackColor(Turbine.UI.Color(0.93,0.66,1,0.63));
...
--   self.panelBackground:SetBackColor(Turbine.UI.Color(0.93,0.66,1,0.63));
...
--         item.duration:SetBackColor(self.effectModifiersPanel.selected == item and Turbine.UI.Color(0.93,0.66,1,0.63) or blueBorderColor);
...
--         if (item.duration.error ~= nil) then item.duration.error:Close() end
--         item.duration.error = nil;
--         item.duration:SetBackColor(self.effectModifiersPanel.selected == item and Turbine.UI.Color(0.63,1,0.63) or blueBorderColor);
...
--         item.skillTextBox:SetBackColor(self.appliedByPanel.selected == item and Turbine.UI.Color(0.93,0.66,1,0.63) or blueBorderColor);
