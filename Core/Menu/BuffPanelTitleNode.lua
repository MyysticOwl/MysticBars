...
function MainTitleNode:SetSelected(selected)
  self.tl:SetBackground("MyysticUI/Core/UI/Resources/social_panel_list_elements_"..(selected and "highlight" or "normal").."_top_left.tga");
  self.t:SetBackground("MyysticUI/Core/UI/Resources/social_panel_list_elements_"..(selected and "highlight" or "normal").."_top_center.tga");
  self.tr:SetBackground("MyysticUI/Core/UI/Resources/social_panel_list_elements_"..(selected and "highlight" or "normal").."_top_right.tga");
  self.l:SetBackground("MyysticUI/Core/UI/Resources/social_panel_list_elements_"..(selected and "highlight" or "normal").."_middle_left.tga");
  self.r:SetBackground("MyysticUI/Core/UI/Resources/social_panel_list_elements_"..(selected and "highlight" or "normal").."_middle_right.tga");
  self.bl:SetBackground("MyysticUI/Core/UI/Resources/social_panel_list_elements_"..(selected and "highlight" or "normal").."_bottom_left.tga");
  self.b:SetBackground("MyysticUI/Core/UI/Resources/social_panel_list_elements_"..(selected and "highlight" or "normal").."_bottom_center.tga");
  self.br:SetBackground("MyysticUI/Core/UI/Resources/social_panel_list_elements_"..(selected and "highlight" or "normal").."_lower_right.tga");
end

function MainTitleNode:MouseEnter(args)
  self:SetSelected(true);
end

function MainTitleNode:MouseLeave(args)
  self:SetSelected(false);
end

function MainTitleNode:MouseDown(args)
