...
import "Turbine";
import "Tonic.UI.DropDownBoxItem";
...
function DropDownBox:Constructor(itemList)
  ...
  self.mb_um:SetBackground("Tonic/UI/Resources/ddbox_border_um.tga");
  ...
  self.mb_lm:SetBackground("Tonic/UI/Resources/ddbox_border_lm.tga");
  ...
  self.mb_ur:SetBackground("Tonic/UI/Resources/ddbox_border_ur.tga");
  ...
  self.mb_mr:SetBackground("Tonic/UI/Resources/ddbox_border_mr.tga");
  ...
  self.mb_lr:SetBackground("Tonic/UI/Resources/ddbox_border_lr.tga");
	...
	self.arrow:SetBackground("Tonic/UI/Resources/dropdown_arrow_closed.tga");
  ...
  self.lb_ul:SetBackground("Tonic/UI/Resources/ddbox_border_ul.tga");
  ...
  self.lb_ml:SetBackground("Tonic/UI/Resources/ddbox_border_ml.tga");
  ...
  self.lb_ll:SetBackground("Tonic/UI/Resources/ddbox_border_ll.tga");
  ...
  self.lb_um:SetBackground("Tonic/UI/Resources/ddbox_border_um.tga");
  ...
  self.lb_lm:SetSize((self.listBox:GetWidth()-36),9);
	self.lb_lm:SetBackground("Tonic/UI/Resources/ddbox_border_lm.tga");
  ...
  self.lb_ur:SetBackground("Tonic/UI/Resources/ddbox_border_ur.tga");
  ...
  self.lb_mr:SetBackground("Tonic/UI/Resources/ddbox_border_mr.tga");
  ...
  self.lb_lr:SetBackground("Tonic/UI/Resources/ddbox_border_lr.tga");
	...
	self.collection = {};	
        ...
        local listItem = Tonic.UI.DropDownBoxItem(self.itemList[i],(self.mainBox:GetWidth()-4));
	...
	if (self.disabled == true)then
		...
		self.arrow:SetBackground("Tonic/UI/Resources/dropdown_arrow_closed_ghosted.tga");
	end
	...
	self.mainBox.MouseEnter =function(sender,args)
		...
		if (self.disabled==false)then
			...
			if (self.show == false)then
				self.arrow:SetBackground("Tonic/UI/Resources/dropdown_arrow_closed_rollover.tga");
			else
				self.arrow:SetBackground("Tonic/UI/Resources/dropdown_arrow_open_rollover.tga");
			end
		end
	end
	...
	self.mainBox.MouseLeave =function(sender,args)
		if (self.disabled==false)then	
			...
			if (self.show == false)then
				...
				self.arrow:SetBackground("Tonic/UI/Resources/dropdown_arrow_open.tga");
