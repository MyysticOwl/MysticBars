...
function GuardianClass:Stance( override )
	...
	configurationService:CreateBar( override, "Stance", 4, 1, 3, 240, 300, QUICKSLOTBAR, function()
...
function GuardianClass:Overpower( override )
	...
	configurationService:CreateBar( override, "Overpower", 30, 1, 2, 240, 350, QUICKSLOTBAR, function()
...
function GuardianClass:Parry( override )
	...
	configurationService:CreateBar( override, "Parry", 8, 1, 4, 240, 400, QUICKSLOTBAR, function()
		configurationService:SetBuffTriggerOptions( true, false );
...
function GuardianClass:Block( override )
	...
	configurationService:CreateBar( override, "Block", 2, 1, 4, 240, 450, QUICKSLOTBAR, function()
		configurationService:SetBuffTriggerOptions( true, false );
