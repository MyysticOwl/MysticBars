...
function Assert.AreEqual( first, second, message )
	if ( not MysticBars.Utils.Compare.AreEqual( first, second ) ) then
...
function Assert.AreNotEqual( first, second, message )
	if ( not MysticBars.Utils.Compare.AreNotEqual( first, second ) ) then
...
function Assert.AreSame( first, second, message )
	if ( not MysticBars.Utils.Compare.AreSame( first, second ) ) then
...
function Assert.AreNotSame( first, second, message )
	if ( not MysticBars.Utils.Compare.AreNotSame( first, second ) ) then
...
function Assert.IsFalse( value, message )
	if ( not MysticBars.Utils.Compare.IsFalse( value ) ) then
...
function Assert.IsTrue( value, message )
	if ( not MysticBars.Utils.Compare.IsTrue( value ) ) then
...
function Assert.IsNil( value, message )
	if ( not MysticBars.Utils.Compare.IsNil( value ) ) then
...
function Assert.IsNotNil( value, message )
	if ( MysticBars.Utils.Compare.IsNil( value ) ) then
