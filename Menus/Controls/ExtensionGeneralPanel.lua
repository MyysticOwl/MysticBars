...
function ExtensionGeneralPanel:Constructor( panel, mainMenu )
	...
	self.orientationList = MyysticUI.Menus.Core.UI.ComboBox();
	...
	self.mousedOverList = MyysticUI.Menus.Core.UI.ComboBox();
	...
	self.removalList = MyysticUI.Menus.Core.UI.ComboBox();
