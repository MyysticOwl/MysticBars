...
function Window:Constructor()
    ...
    self.topLeft:SetBackground("MyysticUI/Menus/Core/Resources/box_silver_top_left.tga");
    ...
    self.topRight:SetBackground("MyysticUI/Menus/Core/Resources/box_silver_top_right.tga");
    ...
    self.bottomLeft:SetBackground("MyysticUI/Menus/Core/Resources/box_silver_bottom_left.tga");
    ...
    self.bottomRight:SetBackground("MyysticUI/Menus/Core/Resources/box_silver_bottom_right.tga");
    ...
    self.resize:SetBackground("MyysticUI/Menus/Core/Resources/resize2.tga");
    ...
    self.close:SetBackground("MyysticUI/Menus/Core/Resources/titlebar_X_2.tga");
    self.close.pressed = false;
    self.close.MouseEnter = function(sender, args)
        self.close:SetBackground("MyysticUI/Menus/Core/Resources/titlebar_X_2_"..(self.close.pressed and "pressed" or "mouseover")..".tga");
    end
    self.close.MouseLeave = function(sender, args)
        self.close:SetBackground("MyysticUI/Menus/Core/Resources/titlebar_X_2"..(self.close.pressed and "_mouseover" or "")..".tga");
    end
    self.close.MouseDown = function(sender, args)
        self.close.pressed = true;
        self.close:SetBackground("MyysticUI/Menus/Core/Resources/titlebar_X_2_pressed.tga");
    end
