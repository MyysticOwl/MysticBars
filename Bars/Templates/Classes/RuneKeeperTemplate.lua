...
function RuneKeeperTemplate:Restoration( override )
	...
	return templateService:CreateBar(override, "Restoration", 1, 1, 240, 350, QUICKSLOTBAR, function(barSettings)
...
function RuneKeeperTemplate:Attun7( override )
	...
	return templateService:CreateBar(override, "Attun 7", 5, 1, 468, 300, QUICKSLOTBAR, function(barSettings)
...
function RuneKeeperTemplate:Attun4( override )
	...
	return templateService:CreateBar(override, "Attun 4", 6, 1, 429, 300, QUICKSLOTBAR, function(barSettings)
		templateService:SetBuffTriggerOptions( true, false, barSettings );
...
function RuneKeeperTemplate:Attun1( override )
	...
	return templateService:CreateBar(override, "Attun 1", 3, 1, 387, 300, QUICKSLOTBAR, function(barSettings)
		templateService:SetBuffTriggerOptions( true, false, barSettings );
...
function RuneKeeperTemplate:Attun1019( override )
	...
	return templateService:CreateBar(override, "Attun 10-19", 1, 1, 508, 336, QUICKSLOTBAR, function(barSettings)
		templateService:SetBuffTriggerOptions( true, false, barSettings );
...
function RuneKeeperTemplate:Attun13( override )
	...
	return templateService:CreateBar(override, "Attun 13", 2, 1, 547, 300, QUICKSLOTBAR, function(barSettings)
		templateService:SetBuffTriggerOptions( true, false, barSettings );
...
function RuneKeeperTemplate:Attun16( override )
	...
	return templateService:CreateBar(override, "Attun 16", 3, 1, 585, 300, QUICKSLOTBAR, function(barSettings)
		templateService:SetBuffTriggerOptions( true, false, barSettings );
...
function RuneKeeperTemplate:Attun19( override )
	...
	return templateService:CreateBar(override, "Attun 19", 3, 1, 623, 300, QUICKSLOTBAR, function(barSettings)
		templateService:SetBuffTriggerOptions( true, false, barSettings );
...
function RuneKeeperTemplate:Attun110( override )
	...
	return templateService:CreateBar(override, "Attun 1-10", 1, 1, 508, 300, QUICKSLOTBAR, function(barSettings)
		templateService:SetBuffTriggerOptions( true, false, barSettings );
