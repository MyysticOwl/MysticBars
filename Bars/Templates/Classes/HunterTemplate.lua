...
function HunterTemplate:Stance( override )
	...
	return templateService:CreateBar(override, "Stance", 1, 4, 240, 300, QUICKSLOTBAR, function(barSettings)
...
function HunterTemplate:Focus3( override )
	...
	return templateService:CreateBar(override, "3 Focus", 1, 4, 240, 350, QUICKSLOTBAR, function(barSettings)
...
function HunterTemplate:Focus6( override )
	...
	return templateService:CreateBar(override, "6 Focus", 1, 2, 240, 400, QUICKSLOTBAR, function(barSettings)
		templateService:SetBuffTriggerOptions( true, false, barSettings );
...
function HunterTemplate:FindThePath( override )
	...
	return templateService:CreateBar(override, "Find The Path", 1, 1, 240, 450, QUICKSLOTBAR, function(barSettings)
		templateService:SetBuffTriggerOptions( false, false, barSettings );
