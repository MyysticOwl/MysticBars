...
function GuardianTemplate:Stance( override )
	...
	return templateService:CreateBar( "Stance", 1, 3, 240, 300, QUICKSLOTBAR, function(localBarSettings)
...
function GuardianTemplate:Overpower( override )
	...
	return templateService:CreateBar( "Overpower", 1, 2, 240, 350, QUICKSLOTBAR, function(localBarSettings)
...
function GuardianTemplate:Parry( override )
	...
	return templateService:CreateBar( "Parry", 1, 4, 240, 400, QUICKSLOTBAR, function(localBarSettings)
		templateService:SetBuffTriggerOptions( true, false, localBarSettings );
...
function GuardianTemplate:Block( override )
	...
	return templateService:CreateBar( "Block", 1, 4, 240, 450, QUICKSLOTBAR, function(localBarSettings)
		templateService:SetBuffTriggerOptions( true, false, localBarSettings );
